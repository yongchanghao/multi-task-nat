...
class LightConvModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--encoder-dynamic-combination', action='store_true',
                            help='using dynamic combination to express encoder output if True')
        parser.add_argument('--decoder-dynamic-combination', action='store_true',
                            help='using dynamic combination to express decoder output if True')
        parser.add_argument('--encoder-linear-combination', action='store_true',
                            help='using linear combination to express encoder output if True')
        parser.add_argument('--decoder-linear-combination', action='store_true',
                            help='using linear combination to express decoder output if True')
...
class LightConvEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        assert not (self.encoder_dynamic_combination and self.encoder_linear_combination)
...
class LightConvDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False, final_norm=True):
        ...
        assert not (self.decoder_dynamic_combination and self.decoder_linear_combination)
    ...
    def forward(self, prev_output_tokens, encoder_out=None, incremental_state=None, **kwargs):
        ...
        if self.decoder_dynamic_combination or self.decoder_linear_combination:
            hiddens = []
        else:
            hiddens = None
...
def base_architecture(args):
    ...
    args.encoder_dynamic_combination = getattr(args, "encoder_dynamic_combination", False)
    args.decoder_dynamic_combination = getattr(args, "decoder_dynamic_combination", False)
    args.encoder_linear_combination = getattr(args, "encoder_linear_combination", False)
    args.decoder_linear_combination = getattr(args, "decoder_linear_combination", False)
